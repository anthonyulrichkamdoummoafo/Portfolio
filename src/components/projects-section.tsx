  ...
  const projects = [
    {
      ...
      description: "A full-stack school management platform built with React, Node.js, and PostgreSQL. It enables real-time student data management, course scheduling, attendance tracking, and performance analytics.",
    ...
    {
      title: "NovaCare",
      description: "An AI-powered healthcare assistant built with Flutter and FastAPI. NovaCare allows users to check symptoms, access FHIR-based medical records, and receive intelligent hospital referrals and AI-driven health insights. It also integrates a multilingual chatbot for virtual consultations.",
      image: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=600&h=400&fit=crop",
      tech: ["Flutter", "FastAPI", "Supabase", "Dialogflow", "AI/ML"],
      github: "https://github.com/anthonyulrichkamdoummoafo/novacare-app",
      live: "https://drive.google.com/file/d/1JFy98KRceUBeahbOCIxn9GagNaKd2koX/view?usp=drive_link",
      featured: true
    },
